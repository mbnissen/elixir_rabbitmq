defmodule ElixirRabbitmqWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(ElixirRabbitmqWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(ElixirRabbitmqWeb.Gettext, "errors", msg, opts)
    # end
